...
//NOT USED!!! Works in orthographic projection but not in perspective projection.
//Tutorial from https://www.youtube.com/watch?v=sD0vNXQYY_U
public class CameraControl : MonoBehaviour
{
    ...
    private void Pan()
    {
        if (Input.GetAxis("Mouse Y") != 0 || Input.GetAxis("Mouse X") != 0)
        {
           ...
           // Vector3 mouseWorldPosDiff = mouseWorldPosStart - Camera.main.ScreenToWorldPoint(new Vector3(Input.mousePosition.x, mouseWorldPosStart.y, Input.mousePosition.z));
           // transform.position += mouseWorldPosDiff;
        }
    }
